...
function _760(_761){
var _762=$.data(_761,"combo").combo.find("input.combo-text");
_762.validatebox("destroy");
$.data(_761,"combo").panel.panel("destroy");
$.data(_761,"combo").combo.remove();
$(_761).remove();
};
function _763(_764){
var _765=$.data(_764,"combo");
var opts=_765.options;
var _766=$.data(_764,"combo").combo;
var _767=$.data(_764,"combo").panel;
var _768=_766.find(".combo-text");
var _769=_766.find(".combo-arrow");
$(document).unbind(".combo").bind("mousedown.combo",function(e){
var p=$(e.target).closest("span.combo,div.combo-panel");
if(p.length){
return;
}
var _76a=$("body>div.combo-p>div.combo-panel");
_76a.panel("close");
});
_766.unbind(".combo");
_767.unbind(".combo");
...
_769.unbind(".combo");
if(!opts.disabled){
_768.bind("mousedown.combo",function(e){
$("div.combo-panel").not(_767).panel("close");
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_764);
break;
case 40:
opts.keyHandler.down.call(_764);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_764);
return false;
case 9:
case 27:
_771(_764);
...
if(opts.editable){
if(_765.timer){
clearTimeout(_765.timer);
}
_765.timer=setTimeout(function(){
var q=_768.val();
if(_765.previousValue!=q){
_765.previousValue=q;
$(_764).combo("showPanel");
opts.keyHandler.query.call(_764,_768.val());
_774(_764,true);
}
},opts.delay);
}
...
_769.bind("click.combo",function(){
if(_767.is(":visible")){
_771(_764);
}else{
...
function _76b(_76c){
var opts=$.data(_76c,"combo").options;
var _76d=$.data(_76c,"combo").combo;
var _76e=$.data(_76c,"combo").panel;
if($.fn.window){
_76e.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_76e.panel("move",{left:_76d.offset().left,top:_76f()});
if(_76e.panel("options").closed){
_76e.panel("open");
opts.onShowPanel.call(_76c);
}
(function(){
if(_76e.is(":visible")){
_76e.panel("move",{left:_770(),top:_76f()});
setTimeout(arguments.callee,200);
}
})();
function _770(){
var left=_76d.offset().left;
if(left+_76e._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_76e._outerWidth();
}
if(left<0){
left=0;
}
...
function _76f(){
var top=_76d.offset().top+_76d._outerHeight();
if(top+_76e._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_76d.offset().top-_76e._outerHeight();
}
if(top<$(document).scrollTop()){
top=_76d.offset().top+_76d._outerHeight();
}
return top;
};
};
function _771(_772){
var opts=$.data(_772,"combo").options;
var _773=$.data(_772,"combo").panel;
_773.panel("close");
opts.onHidePanel.call(_772);
};
function _774(_775,doit){
var opts=$.data(_775,"combo").options;
var _776=$.data(_775,"combo").combo.find("input.combo-text");
_776.validatebox(opts);
if(doit){
_776.validatebox("validate");
}
};
...
if(_779){
opts.disabled=true;
$(_778).attr("disabled",true);
_77a.find(".combo-value").attr("disabled",true);
_77a.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_778).removeAttr("disabled");
_77a.find(".combo-value").removeAttr("disabled");
_77a.find(".combo-text").removeAttr("disabled");
}
};
function _77b(_77c){
var opts=$.data(_77c,"combo").options;
var _77d=$.data(_77c,"combo").combo;
if(opts.multiple){
_77d.find("input.combo-value").remove();
}else{
_77d.find("input.combo-value").val("");
}
_77d.find("input.combo-text").val("");
};
function _77e(_77f){
var _780=$.data(_77f,"combo").combo;
return _780.find("input.combo-text").val();
};
function _781(_782,text){
var _783=$.data(_782,"combo").combo;
_783.find("input.combo-text").val(text);
_774(_782,true);
$.data(_782,"combo").previousValue=text;
};
function _784(_785){
var _786=[];
var _787=$.data(_785,"combo").combo;
_787.find("input.combo-value").each(function(){
_786.push($(this).val());
});
return _786;
};
function _788(_789,_78a){
var opts=$.data(_789,"combo").options;
var _78b=_784(_789);
var _78c=$.data(_789,"combo").combo;
_78c.find("input.combo-value").remove();
var name=$(_789).attr("comboName");
for(var i=0;i<_78a.length;i++){
var _78d=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_78c);
if(name){
_78d.attr("name",name);
}
_78d.val(_78a[i]);
...
if(aa.length!=_78a.length||_78a.length!=_78b.length){
if(opts.multiple){
opts.onChange.call(_789,_78a,_78b);
}else{
opts.onChange.call(_789,_78a[0],_78b[0]);
}
}
};
function _78e(_78f){
...
_788(_795,opts.value);
}else{
_791(_795,opts.value);
}
}else{
_788(_795,[]);
}
opts.originalValue=_784(_795);
}else{
_791(_795,opts.value);
...
$.fn.combo=function(_796,_797){
if(typeof _796=="string"){
return $.fn.combo.methods[_796](this,_797);
}
_796=_796||{};
return this.each(function(){
var _798=$.data(this,"combo");
if(_798){
$.extend(_798.options,_796);
}else{
var r=init(this);
_798=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_796),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_798.combo).attr("readonly",!_798.options.editable);
_75a(this);
_777(this,_798.options.disabled);
_752(this);
_763(this);
_774(this);
_794(this);
...
var _79a=$.data(jq[0],"combo").combo.find("input.combo-text");
return _79a.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_77b(this);
});
...
return _784(jq[0]);
},setValues:function(jq,_79b){
return jq.each(function(){
_788(this,_79b);
});
},getValue:function(jq){
return _78e(jq[0]);
},setValue:function(jq,_79c){
return jq.each(function(){
_791(this,_79c);
});
}};
$.fn.combo.parseOptions=function(_79d){
var t=$(_79d);
return $.extend({},$.fn.validatebox.parseOptions(_79d),$.parser.parseOptions(_79d,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});
};
...
},onChange:function(_79e,_79f){
}});
})(jQuery);
(function($){
function _7a0(_7a1,_7a2){
var _7a3=$(_7a1).combo("panel");
var item=_7a3.find("div.combobox-item[value=\""+_7a2+"\"]");
if(item.length){
if(item.position().top<=0){
var h=_7a3.scrollTop()+item.position().top;
_7a3.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_7a3.height()){
var h=_7a3.scrollTop()+item.position().top+item.outerHeight()-_7a3.height();
_7a3.scrollTop(h);
}
}
}
...
function _7a4(_7a5){
var _7a6=$(_7a5).combo("panel");
var _7a7=$(_7a5).combo("getValues");
var item=_7a6.find("div.combobox-item[value=\""+_7a7.pop()+"\"]");
if(item.length){
...
item=_7a6.find("div.combobox-item:visible:last");
}
var _7a8=item.attr("value");
_7a9(_7a5,_7a8);
_7a0(_7a5,_7a8);
};
function _7aa(_7ab){
var _7ac=$(_7ab).combo("panel");
var _7ad=$(_7ab).combo("getValues");
var item=_7ac.find("div.combobox-item[value=\""+_7ad.pop()+"\"]");
if(item.length){
...
item=_7ac.find("div.combobox-item:visible:first");
}
var _7ae=item.attr("value");
_7a9(_7ab,_7ae);
_7a0(_7ab,_7ae);
};
function _7a9(_7af,_7b0){
var opts=$.data(_7af,"combobox").options;
var data=$.data(_7af,"combobox").data;
if(opts.multiple){
var _7b1=$(_7af).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_7b0){
opts.onSelect.call(_7af,data[i]);
return;
}
}
};
function _7b3(_7b4,_7b5){
var opts=$.data(_7b4,"combobox").options;
var data=$.data(_7b4,"combobox").data;
var _7b6=$(_7b4).combo("getValues");
...
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_7b5){
opts.onUnselect.call(_7b4,data[i]);
return;
}
}
};
function _7b2(_7b7,_7b8,_7b9){
var opts=$.data(_7b7,"combobox").options;
var data=$.data(_7b7,"combobox").data;
var _7ba=$(_7b7).combo("panel");
_7ba.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
vv.push(v);
ss.push(s);
_7ba.find("div.combobox-item[value=\""+v+"\"]").addClass("combobox-item-selected");
}
$(_7b7).combo("setValues",vv);
if(!_7b9){
$(_7b7).combo("setText",ss.join(opts.separator));
}
};
function _7bb(_7bc){
var opts=$.data(_7bc,"combobox").options;
var data=[];
$(">option",_7bc).each(function(){
var item={};
...
function _7bd(_7be,data,_7bf){
var opts=$.data(_7be,"combobox").options;
var _7c0=$(_7be).combo("panel");
$.data(_7be,"combobox").data=data;
var _7c1=$(_7be).combobox("getValues");
_7c0.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_7c0);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_7be,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_7c1.length){
_7b2(_7be,[_7c1[_7c1.length-1]],_7bf);
}else{
_7b2(_7be,[],_7bf);
}
}
opts.onLoadSuccess.call(_7be,data);
$(".combobox-item",_7c0).hover(function(){
...
_7b3(_7be,item.attr("value"));
}else{
_7a9(_7be,item.attr("value"));
}
}else{
_7a9(_7be,item.attr("value"));
$(_7be).combo("hidePanel");
}
});
};
function _7c2(_7c3,url,_7c4,_7c5){
var opts=$.data(_7c3,"combobox").options;
if(url){
opts.url=url;
}
_7c4=_7c4||{};
if(opts.onBeforeLoad.call(_7c3,_7c4)==false){
return;
}
opts.loader.call(_7c3,_7c4,function(data){
_7bd(_7c3,data,_7c5);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _7c6(_7c7,q){
var opts=$.data(_7c7,"combobox").options;
if(opts.multiple&&!q){
_7b2(_7c7,[],true);
}else{
_7b2(_7c7,[q],true);
...
if(opts.mode=="remote"){
_7c2(_7c7,null,{q:q},true);
}else{
var _7c8=$(_7c7).combo("panel");
_7c8.find("div.combobox-item").hide();
var data=$.data(_7c7,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_7c7,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_7c8.find("div.combobox-item[value=\""+v+"\"]");
item.show();
if(s==q){
_7b2(_7c7,[v],true);
...
function _7c9(_7ca){
var opts=$.data(_7ca,"combobox").options;
$(_7ca).addClass("combobox-f");
$(_7ca).combo($.extend({},opts,{onShowPanel:function(){
$(_7ca).combo("panel").find("div.combobox-item").show();
_7a0(_7ca,$(_7ca).combobox("getValue"));
opts.onShowPanel.call(_7ca);
}}));
};
$.fn.combobox=function(_7cb,_7cc){
if(typeof _7cb=="string"){
var _7cd=$.fn.combobox.methods[_7cb];
if(_7cd){
...
_7cb=_7cb||{};
return this.each(function(){
var _7ce=$.data(this,"combobox");
if(_7ce){
$.extend(_7ce.options,_7cb);
_7c9(this);
}else{
_7ce=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_7cb)});
_7c9(this);
_7bd(this,_7bb(this));
}
if(_7ce.options.data){
_7bd(this,_7ce.options.data);
}
_7c2(this);
});
};
...
return jq.each(function(){
$(this).combo("clear");
var _7d1=$(this).combo("panel");
_7d1.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_7d2){
return jq.each(function(){
_7a9(this,_7d2);
});
},unselect:function(jq,_7d3){
return jq.each(function(){
_7b3(this,_7d3);
});
}};
$.fn.combobox.parseOptions=function(_7d4){
var t=$(_7d4);
return $.extend({},$.fn.combo.parseOptions(_7d4),$.parser.parseOptions(_7d4,["valueField","textField","mode","method","url"]));
};
